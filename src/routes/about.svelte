...
<div class="content flex flex-col items-center">
    ...
    <div>
        <img src="/images/c82.png" class="p-20 pt-10" alt="A title page of the work ">
    </div>

    <p> 
        Please go and check out his website, featuring some awesome projects, and buy a poster!
    </p>
